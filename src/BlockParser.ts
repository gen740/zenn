...
export const parseBlock = async (
  ...
  for (const block of blocks.results) {
    ...
    switch (b.type) {
      ...
      case "template":
        console.log("Template block is not supported");
        break;
      case "synced_block":
        console.log("Synced block is not supported");
        break;
      case "child_page":
        console.log("Child page block is not supported");
        break;
      case "child_database":
        console.log("Child database block is not supported");
        break;
      case "equation":
        result.push("");
      ...
      case "breadcrumb":
        console.log("Breadcrumb block is not supported");
        break;
      case "table_of_contents":
        // Table of contents is automatically generated by zenn
        break;
      case "column_list":
        console.log("Column list block is not supported");
        break;
      case "column":
        console.log("Column block is not supported");
        break;
      case "link_to_page":
        console.log("Link to page block is not supported");
        break;
      case "table":
        result.push("");
        break;
      ...
      case "pdf":
        ...
        break;
      case "file":
        console.log("File block is not supported");
        break;
      case "audio":
        console.log("Audio block is not supported");
        break;
      case "link_preview":
        result.push("");
        result.push(`${b.link_preview.url}`);
        break;
      case "unsupported":
        console.log("Unsupported block is not supported");
        break;
    }
    if (b.has_children) {
